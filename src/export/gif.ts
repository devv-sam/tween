...
export function exportGif(comp: Composition, library: ModuleAsset[], w = 800, h = 600, imageOf?: ImageLookup, source?: Size): Blob {
  ...
  for (let f = 0; f < total; f++) {
    renderFrame(ctx, comp, f / total, w, h, library, imageOf, source);
